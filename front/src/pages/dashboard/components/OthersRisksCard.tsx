    ...
    return (
        ...
        <div className="border p-6 border-gray-200/50 backdrop-blur-xl  dark:border-gray-700/50 rounded-xl  bg-white/80 dark:bg-slate-900/80 ">
            ...
            <div className="flex items-start justify-between gap-10">
                ...
                {/* First */}
                <div className={`p-3 rounded-full size-20 bg-red-50 dark:bg-red-900/40 flex items-center justify-center group-hover:scale-110 transition-all duration-200`}>
...
export default OthersRisksCard