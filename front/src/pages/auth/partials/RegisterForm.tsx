...
const registerSchema = z.object({
    name:  z.string().trim().min(3, {message: "votre nom est trop court"}).max(12, {message: "Votre nom est trop long"}),
